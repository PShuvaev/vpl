...
namespace VisualPracticalLanguage
{
	public class ElementPanel : FlowLayoutPanel
	{
		...
		public ElementPanel (Action<DraggableControl> onAddFunctionToWorkspace, Dictionary<string, Func<DraggableControl>> elements)
		{
		...
		void AddBtn(string text, Func<DraggableControl> getControl){
